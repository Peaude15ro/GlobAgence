                ...
                <div class="col-7 col-sm-9">
                    <div class="tab-content" id="vert-tabs-right-tabContent">
                        <div class="tab-pane fade" id="vert-tabs-right-home" role="tabpanel" aria-labelledby="vert-tabs-right-home-tab">
                            <?php include('../page/property/user.php'); ?>
                        </div>
                        <div class="tab-pane fade" id="vert-tabs-right-profile" role="tabpanel" aria-labelledby="vert-tabs-right-profile-tab">
                            <?php include('../page/property/feature.php'); ?>
                        </div>
                        <div class="tab-pane fade active show" id="vert-tabs-right-messages" role="tabpanel" aria-labelledby="vert-tabs-right-messages-tab">
                            <?php include('../page/property/test.php'); ?>
                        </div>
                        <div class="tab-pane fade" id="vert-tabs-right-settings" role="tabpanel" aria-labelledby="vert-tabs-right-settings-tab">
                            <?php include('../page/property/test2.php'); ?>
                        </div>
                    </div>
                </div>
            </div>
